...
The Hub combines local published Stores with published Stores from the listed databases. Local cards open chat pages on the current site; remote cards use the source site's **Endpoint** so users are sent to the correct OpenAgent instance.
