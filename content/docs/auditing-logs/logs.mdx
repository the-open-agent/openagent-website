...
<Callout type="warn">
  **Screenshot placeholder:** Records page (audit trail) showing filters and a single record detail.
  Add a second screenshot for Usage showing token/cost trends over time.
</Callout>
