...
<Card title="OpenAgent installed" icon="package">
  See deployment options in the section below.
</Card>

<Card title="API key" icon="key">
  From a model provider: DeepSeek, OpenAI, Anthropic, or any supported provider.
</Card>
...
<Cards>
  ...
  <Card title="Architecture" description="Understand the four layers of OpenAgent." href="/docs/what-is-openagent" />
</Cards>
