...
Store owners can submit a Store for review from the Store edit page. Admins can set **Publish State** to **Private**, **Pending Review**, **Published**, or **Rejected**. The Hub lists only Stores whose publish state is **Published**, and each Hub card opens a chat with that Store.
