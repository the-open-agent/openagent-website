...
Opening an issue shows its full description and a threaded reply list. Replies reuse the same rich comment editor as agent [comments](/docs/agent-page/overview#comments), including emoji and inline images.
