...
<Steps>
  <Step>
    ...
    <Tabs items={['Binary (Recommended)', 'Docker', 'Development']}>
    ...
    **Windows** — download `openagent-windows-amd64.exe` and double-click it, or run from PowerShell:
    ```powershell
    .\openagent-windows-amd64.exe
    ```
