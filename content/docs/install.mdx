...
<Steps>
  <Step>
    ...
    **macOS** — download the binary for your platform (`openagent_darwin_x86` for Intel, `openagent_darwin_arm64` for Apple Silicon) and run:
    ...
    Requires Go 1.25.0+, Node.js 20+, Yarn 1.x, and MySQL 8.0+.
    ...
    The install scripts support `OPENAGENT_VERSION`, `INSTALL_DIR`, and `BIN_DIR` if you need to pin a release or choose custom install paths.
