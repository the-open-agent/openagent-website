...
<Callout type="warn">
  **Screenshot placeholder:** Providers → Add Provider (Embedding) form + Store edit page selecting Embedding Provider.
  Make the “one embedding space per Store” rule visually obvious.
</Callout>
